...
from anki_web.cards.views import CreateCardView, ListCardsView, upload_file, ListCardsDayView, show_answer, delete_select_cards, delete_all_cards,DeleteSelectView
...
urlpatterns = [
    ...
    path('<int:pk>/select/', DeleteSelectView.as_view(), name='select'),
